...
export class FooterComponent implements OnInit {
    public lat: number = 25.3918488;
    public lng: number = 49.5634575;
    ...
    public onFeedbackFormSubmit(values: Object): void {
        // if (this.feedbackForm.valid) {
            // this.sendTelegram.sendFeedback(values['email'], values['message']);
        // }
    }

    public onSubscribeFormSubmit(values: Object): void {
        // if (this.subscribeForm.valid) {
            // this.sendTelegram.subscribeWithNewsletter(values['email']);
        // }
    }
